...
int main(){
    ...
    // IF positive float / 0 = +inf, negative float / 0 = -inf
    // SET PRECISION SHOWS THE AMOUNT , BUT THE PRECISE FOLLOWING WILL ONLY LAST ACCORING TO IF ITS FLOAT OR DOUBLE OR NAH
    /*
    Think of std::setprecision(n) like this:
    “Hey std::cout, please show me up to n digits when printing numbers.”

    But then the float/double responds:

    “Sure... but I only know this many accurate digits, the rest are just approximations.
    */
}