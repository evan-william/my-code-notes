// Template Specialization this to bypass the default mechanism of func template work
...
int main(){
    ...
    // WITHOUT SPECIALIZATION THE FUNC WILL COMPARE THE ADRESS FOR WILD AND ANIMAL NOT THE STRING ITSELF
    return 0;
}