...
int main(){
    ...
    */
    ...
    int* p_number {}; // Will initialize with nullptr    (*p_number) will become a pointer to int, that have a thing inside {}
    ...
    /*
    &int_var gets the memory address of the variable int_var.
    p_int stores that address.
    */
    ...
    // std::cout << "value : " << (*p_int2).compute() << std::endl; // To Derefrence and call method
    // std::cout << "volume : " << p_cylinder1->volume() << std::endl; // This can also be done to derefrence  and call method
