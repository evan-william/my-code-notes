...
def menu(menu):
    return f"""
    ========================================
            COMPUTER RUSSIAN ROULLET
                by: Evan William
    ========================================
    - You have a few Bullets.
    - 1 bullet will shut down your device :)
...
def countdown_to_deletion():
    print("You died!, shutting down your device in 10 seconds :)")
    print("\n💀 SYSTEM SHUTDOWN INITIATED! 💀\n")
    
    for i in range(10, 0, -1):
        print(f"Shutting down in {i} seconds...", end="\r")  # Print countdown on same line
        beep_sound.play() 
        time.sleep(1)
